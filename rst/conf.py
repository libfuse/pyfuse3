...
# Sphinx 9 autodoc otherwise tries to execute src/pyfuse3/__init__.pyi as a
# module, which fails on its standard relative imports. Load the real
# (compiled) module instead -- it also carries the docstrings autodoc needs.
os.environ.setdefault('SPHINX_AUTODOC_IGNORE_NATIVE_MODULE_TYPE_STUBS', '1')
